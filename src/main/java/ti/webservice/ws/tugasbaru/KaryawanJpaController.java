...
import ti.webservice.ws.tugasbaru.exceptions.NonexistentEntityException;
import ti.webservice.ws.tugasbaru.exceptions.PreexistingEntityException;
...
public class KaryawanJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.webservice_ws.tugasbaru_jar_0.0.1-SNAPSHOTPU");
